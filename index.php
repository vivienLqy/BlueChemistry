...
?>  
    <div class="container d-flex justify-content-center">
        <div class="mt-5 bg-op text-white w-50 p-3 d-flex flex-column  align-items-center">
            ...
            <p class="text-center">Bienvenue chez BlueChemistry, votre partenaire de confiance pour des solutions de santé accessibles et de qualité. Notre équipe dévouée travaille sans relâche pour vous offrir les meilleurs services dans le domaine de la vente de médicaments. Faisons connaissance avec ceux qui contribuent chaque jour à la réussite de notre mission.</p>
        ...
        <div class="containers">
            <?php foreach ($potions as $potion): ?>
                <div class="img-box position-relative" style="--img: url(<?= $potion['pathImg']?>);">
                    <div class="desc bg-secondary position-absolute bottom-0 start-50 translate-middle rounded-2 w-75 bg-opacity-50 text-center text-light">
                        <h2><?= $potion['title'] ?></h2>
                        <p><?= $potion['comment'] ?></p>
                        <p><?= $potion['price'] ?></p>
                        <a href="#" class="btn btn-success w-50 mb-2" role="button">Découvrir</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
